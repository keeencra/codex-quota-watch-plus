...
**项目版本 v3.1.0 · 小更新 · 第 13 次迭代** · [查看各版本变化](CHANGELOG.md#版本索引)
...
最新 v3.1.0 集成 Mac 菜单栏显示端，统一小／中／大号组件，新增重置卡只读展示，并修复套餐识别、组件单色显示及 token 重复统计。Mac 显示端可独立使用，手机与手表按需部署；[查看新增内容和 Bug 修复](CHANGELOG.md)。
