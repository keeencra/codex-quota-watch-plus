...
**项目版本 v3.3.0 · 小更新 · 第 16 次迭代** · [查看各版本变化](CHANGELOG.md#版本索引)
...
最新 v3.3.0 新增 Mac 最近 7 天 Codex／DeepSeek 每日 token 趋势，将余额、精确明细和任务详情整合为统一滚动面板，刷新保留阅读位置。[查看更新说明](CHANGELOG.md)。
