...
**项目版本 v3.0.1 · Bug 修复 · 第 12 次迭代** · [查看各版本变化](CHANGELOG.md#版本索引)
...
最新 v3.0.1 修复手机和手表任务列表遗漏空项目的问题，并同步 Mac 项目顺序；保留 v3.0.0 的品牌、DeepSeek 余额和两套小组件布局。安装只需 Mac＋iPhone，手表可选；[查看新增内容和 Bug 修复](CHANGELOG.md)。
