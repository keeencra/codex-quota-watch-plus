...
## v3.0.0 · 大更新 · 2026-09-13 · 更新 10 — 图解更新日志

**对比上一版：** [v2.0.0 `e878afd`](https://github.com/keeencra/codex-quota-watch-plus/commit/e878afd33fe09d50f8b329b14717b43584cbb8b2)。第 11 次迭代；本次新增文档与图片，按项目约定归为大更新。

### 新增内容
- 为下方 v2.0.0 的手表导航与标题修复补充两张「改动前／改动后」对比图，让用户直接看到变化。
- 将界面更新配图写入长期发布规范：图片紧邻对应改动，说明版本、触发入口和变化；优先使用同尺寸真实截图，示意图必须明确标注。

### Bug 修复
- 无新增 App Bug 修复；下方图片展示的是 v2.0.0 已完成的修复。

### 改进
- 保留文字说明与图片替代文字，支持图片未加载时阅读；保留可编辑 SVG 和用于展示的 PNG。
- 图片按改动版本命名，后续更新不覆盖旧图；GitHub Release 使用固定版本图片链接。

### 验证与升级说明
- 两张图片已静态渲染并检查文字、对比关系及排版；已检查 SVG 结构、文档本地链接与版本一致性。示意图不代表真机截图或新增设备验收。
- 本次没有 App 或 Mac 服务代码变化，无需重新签名、安装或修改配置。发布后核对远端文件及固定版本源码包。

## v2.0.0 · 大更新 · 2026-09-13 · 更新 9 — 手表导航修复与长期维护

**对比上一版：** [v1.0.0 `6ee2638`](https://github.com/keeencra/codex-quota-watch-plus/commit/6ee263839d0ff5a76a28220768b2d920adeaa580)。第 10 次迭代；包含维护文档新增，按项目约定归为大更新。
...
*以上为本项目 v1.0.0 → v2.0.0 的行为／布局示意，非设备截图；于 v3.0.0 补充，不表示 v3.0.0 再次修改 App。可编辑源图：[导航](docs/assets/v2-navigation-comparison.svg) · [标题](docs/assets/v2-header-comparison.svg)。*
...
当前项目版本 **v3.0.0 · 大更新 · 第 11 次迭代**。历史 v0.1.0～v0.8.0 使用旧编号并保持不变，下表按内容补充更新类型；前 5 个编号由已有日志追溯补齐，不代表当时已有同名标签或 Release。
...
| --- | --- | --- | --- | --- |
| 11 | v3.0.0 | 大更新 | 2026-09-13 | 图解更新日志与后续配图规范 |
