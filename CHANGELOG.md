...
当前项目版本 **v2.0.0 · 大更新 · 第 10 次迭代**。历史 v0.1.0～v0.8.0 使用旧编号并保持不变，下表按内容补充更新类型；前 5 个编号由已有日志追溯补齐，不代表当时已有同名标签或 Release。
...
- **迭代次数独立累计**：只有有效产品版本发布才加 1。历史 v0.1.0～v2.0.0 的编号与累计 10 次记录保留，不追溯重排；本次误标的 v3.0.0 不算有效产品版本或第 11 次迭代。
