...
当前项目版本 **v0.8.0 · 第 8 次迭代**。前 5 个编号按已有更新日志追溯补齐，不代表当时已创建同名 Git 标签或 GitHub Release，也不按单个 Git 提交计数。开发阶段每次公开更新（含文档更新）递增中间一位：`v0.8.0 → v0.9.0`。

| 迭代 | 项目版本 | 日期 | 主要变化 |
| --- | --- | --- | --- |
| 8 | v0.8.0 | 2026-09-12 | 结束提醒显示项目名与任务标题 |
| 7 | v0.7.0 | 2026-09-12 | 所有版本下载与 Release 入口 |
| 6 | v0.6.0 | 2026-09-12 | 版本编号、版本索引及发布规范 |
| 5 | v0.5.0 | 2026-09-12 | Codex 项目分组与侧栏任务标题同步 |
| 4 | v0.4.0 | 2026-09-12 | 界面图库与功能导览 |
| 3 | v0.3.0 | 2026-09-12 | 修复 iPhone 总览三个入口跳转 |
| 2 | v0.2.0 | 2026-09-12 | 任务总览与逐项远程审批 |
| 1 | v0.1.0 | 2026-09-11 | 首次公开功能汇总 |
